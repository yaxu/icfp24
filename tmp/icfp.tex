...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{fig8 }\OtherTok{=}\NormalTok{ blend }\OperatorTok{\textless{}$\textgreater{}}\NormalTok{ (\_slow }\DecValTok{4}\NormalTok{ sinewave) }\OperatorTok{\textless{}*\textgreater{}\textgreater{}}\NormalTok{ atom blue }\OperatorTok{\textless{}*\textgreater{}\textgreater{}}\NormalTok{ atom red}
\CommentTok{{-}{-} fig8 = \_slow 12 sinewave \textasciigrave{}innerBind\textasciigrave{} \textbackslash{}x}
\CommentTok{{-}{-}          {-}\textgreater{} atom blue \textasciigrave{}innerBind\textasciigrave{} \textbackslash{}b}
\CommentTok{{-}{-}          {-}\textgreater{} atom red \textasciigrave{}innerBind\textasciigrave{} \textbackslash{}a}
\CommentTok{{-}{-}          {-}\textgreater{} return $ blend ((x+1)/2) a b}
\end{Highlighting}
\end{Shaded}
...
This is a rather thorny issue, but in practice, finding the right order
of application is taken care of in the design of the DSL, and is not
